...
<!-- Mirrored from template.hasthemes.com/jesco/jesco/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 04 Jul 2022 05:22:08 GMT -->
<head>
    <meta charset="UTF-8">
                    ...
                    <div class="col align-self-center d-none d-lg-block">
                        <div class="main-menu">
                            <ul>
                                ...
                                <li class="dropdown "><a href="#">Products <i class="pe-7s-angle-down"></i></a>
                                    <ul class="sub-menu">
                                        @foreach ($categories as $category)
                                        <li><a href="">{{$category->name}}</a></li>
                                        {{-- <li><a href="blog-grid.html">Brand</a></li> --}}
                                        @endforeach
                                    </ul>
                                </li>
                        ...
                        <div class="col-md-6 col-lg-3 mb-md-30px mb-lm-30px">
                            <div class="single-wedge">
                                <div class="footer-logo">
                                    <a href="index-2.html"><img src="assets/images/logo/logo-white.png" alt=""></a>
                                </div>
                        ...
                        <div class="col-md-3 col-lg-2 col-sm-6 mb-lm-30px pl-lg-50px">
                            <div class="single-wedge">
                                ...
                                <div class="footer-links">
                                    <div class="footer-row">
                                        <ul class="align-items-center">
                                            <li class="li"><a class="single-link" href="index-2.html">Jesco</a>
                                            </li>
...
<!-- Mirrored from template.hasthemes.com/jesco/jesco/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 04 Jul 2022 05:22:14 GMT -->
</html>
